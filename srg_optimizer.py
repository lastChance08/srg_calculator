...
def fitness_func(ga_instance, solution, solution_idx):
    theta1 = solution[0] * np.pi / 180
    theta2 = theta1 + solution[1] * np.pi / 180
    theta_end = theta2 + solution[2] * np.pi / 180
...
gene_space = [{'low': -3, 'high': 4, "step": 0.1}, {'low': 0, 'high': 8, "step": 0.1}, {'low': 0, 'high': 12, "step": 0.1}]
